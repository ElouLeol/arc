...
level_color=[THECOLORS['black'],(28,51,0),(0,76,77),(41,49,51),THECOLORS['black'],(28,51,0),(0,76,77),(41,49,51),(109,63,91)]
...
def spawn_ball(space,pos,direction):
	...
	if lock_balls<=20:
		...
		def constant_velocity(body,gravity,damping,dt):
			body.velocity=body.velocity.normalized()*d_ball_velocity
...
def setup_level(space,player_body):
	...
	global spawnballs
	spawnballs=spawn_ball(space,player_body.position+(0,40), random.choice([(1,10),(-1,10)]))
	...
	def remove_brick(arbiter,space,data):
		...
		def constant_velocity(body,gravity,damping,dt):
			body.velocity=body.velocity.normalized()*d_ball_velocity
		spawnballs.velocity_func=constant_velocity		
...
def main():
	...
	while main_run:
		...
		for line in static_lines:
			...
			#line.density=100
			#line.mass=472689
			#line.collision_type=space.add_collision_handler()
		space.add(static_lines) #Добавление в space

		#Тест! потом удалить
		static_lines=[pymunk.Segment(space.static_body, (50, 50), (50, 550), 4)
					,pymunk.Segment(space.static_body, (50, 550), (550, 550), 4)
					,pymunk.Segment(space.static_body, (550, 550), (550, 50), 4)
					]
		for line in static_lines:
			line.color=THECOLORS['lightgray']
			line.elasticity=1.0
